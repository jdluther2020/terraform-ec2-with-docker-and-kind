...
# Three essential commands to note. For more see blog above.
# 1. REPO=terraform-ec2-with-docker-and-kind && git clone https://github.com/jdluther2020/$REPO.git && cd $REPO
# 2. terraform init && terraform apply -auto-approve -var my_ip=$(curl -s ifconfig.me)
